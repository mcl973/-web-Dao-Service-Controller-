...
public Map<String,mycontext> SelectFordata(String methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from mycontext where data=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
...
public Map<String,mycontext> SelectForcontext(String methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from mycontext where context=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
mycontext cn = new mycontext();
...
public Map<String,mycontext> SelectForcount(long methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from mycontext where count=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
mycontext cn = new mycontext();
...
public Map<String,mycontext> SelectForusername(String methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from mycontext where username=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
mycontext cn = new mycontext();
...
readLock.lock();
 resultSet = statement.executeQuery("select "+out+" from mycontext where "+select+";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
mycontext cn = new mycontext();

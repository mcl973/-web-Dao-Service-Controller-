...
import SqlInit.AchieveAllTableAndInstance.CreateFile.Dao.home;
...
public Map<String,home> SelectForhometocommunity(long methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from home where hometocommunity=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
home cn = new home();
String var0 = resultSet.getString("hometocommunity");
cn.sethometocommunity((long) TypeTrans.getvalue("long",var0));
String var1 = resultSet.getString("hometoperson");
cn.sethometoperson((long) TypeTrans.getvalue("long",var1));
String var2 = resultSet.getString("homename");
cn.sethomename((String) TypeTrans.getvalue("String",var2));
String var3 = resultSet.getString("hmesize");
cn.sethmesize((long) TypeTrans.getvalue("long",var3));
String var4 = resultSet.getString("homeid");
cn.sethomeid((long) TypeTrans.getvalue("long",var4));
classmap.put(m+"",cn);
m++;
}return classmap;
}
...
public Map<String,home> SelectForhometoperson(long methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from home where hometoperson=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
home cn = new home();
...
public Map<String,home> SelectForhomename(String methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from home where homename=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
home cn = new home();
...
public Map<String,home> SelectForhmesize(long methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from home where hmesize=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
home cn = new home();
...
public Map<String,home> SelectForhomeid(long methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from home where homeid=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
home cn = new home();
...
readLock.lock();
 resultSet = statement.executeQuery("select "+out+" from home where "+select+";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
home cn = new home();
...
String sets = "";
 ...
 k = 0;
String sql = "update home  set "+sets+" where "+wheres+";";
...
deletes+=" , "+map.getKey()+"=\""+map.getValue()+"\"";
 ...
 String sql = "delete from home where "+deletes+";";
 writeLock.lock();
 boolean istrue = !statement.execute(sql);
 writeLock.unlock();
return istrue;
...
public boolean insertmethod(home object)throws Exception{
...
insertafter += "\""+field.get(object)+"\"";
 ...
 String sql = "insert into home("+insertbefore+") values("+insertafter+");";
writeLock.lock();
 boolean istrue = !statement.execute(sql);
 writeLock.unlock();
return istrue; 

...
public Map<String,user> SelectForbirthday(Date methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from user where birthday=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
...
public Map<String,user> SelectForaddress(String methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from user where address=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
user cn = new user();
...
public Map<String,user> SelectForsex(String methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from user where sex=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
user cn = new user();
...
public Map<String,user> SelectForid(long methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from user where id=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
user cn = new user();
...
public Map<String,user> SelectForusername(String methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from user where username=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
user cn = new user();
...
readLock.lock();
 resultSet = statement.executeQuery("select "+out+" from user where "+select+";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
user cn = new user();

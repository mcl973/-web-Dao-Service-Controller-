...
public Map<String,orderdetail> SelectFororders_id(long methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from orderdetail where orders_id=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
...
public Map<String,orderdetail> SelectForitems_id(long methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from orderdetail where items_id=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
orderdetail cn = new orderdetail();
...
public Map<String,orderdetail> SelectForitems_num(long methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from orderdetail where items_num=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
orderdetail cn = new orderdetail();
...
public Map<String,orderdetail> SelectForid(long methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from orderdetail where id=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
orderdetail cn = new orderdetail();
...
readLock.lock();
 resultSet = statement.executeQuery("select "+out+" from orderdetail where "+select+";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
orderdetail cn = new orderdetail();

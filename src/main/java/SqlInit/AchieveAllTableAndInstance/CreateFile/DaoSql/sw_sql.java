...
public Map<String,sw> SelectForrequired_bw(String methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from sw where required_bw=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
...
public Map<String,sw> SelectForsw_mac(String methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from sw where sw_mac=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
sw cn = new sw();
...
public Map<String,sw> SelectFormax_delay(String methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from sw where max_delay=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
sw cn = new sw();
...
public Map<String,sw> SelectForsw_id(String methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from sw where sw_id=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
sw cn = new sw();
...
public Map<String,sw> SelectForsw_ip(String methodfield_) throws Exception{
  ...
  ResultSet resultSet;
readLock.lock();
 resultSet = statement.executeQuery("select * from sw where sw_ip=\"" +methodfield_+"\";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
sw cn = new sw();
...
readLock.lock();
 resultSet = statement.executeQuery("select "+out+" from sw where "+select+";");
 readLock.unlock();
  int m = 0;
  while(resultSet.next()){
sw cn = new sw();
